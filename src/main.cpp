...
class IrukaApp : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<IrukaApp>(ctx);
    }

    IrukaApp(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "Iruka", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        // Initialize logging
        auto log_file = exe_dir / "Iruka.log";
        rex::InitLogging(log_file.string().c_str(), spdlog::level::debug);
        REXLOG_INFO("Iruka starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "Iruka", 1280, 720);
        if (!window_) {
...
XE_DEFINE_WINDOWED_APP(Iruka, IrukaApp::Create)
